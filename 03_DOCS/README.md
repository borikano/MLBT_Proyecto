...
| Bloque | Ruta | Propósito |
|---|---|---|
| Front End React | [../01_FRONT_END/01_REACT_AP07](../01_FRONT_END/01_REACT_AP07) | Interfaz React correspondiente a AP07. |
| Front End base | [../01_FRONT_END/02_INTERFAZ_BASE](../01_FRONT_END/02_INTERFAZ_BASE) | Interfaz HTML, CSS y JavaScript base. |
| API Node | [../02_BACK_END/01_API_NODE](../02_BACK_END/01_API_NODE) | API REST con Node.js, Express, Prisma y MySQL/MariaDB. |
| Spring Web | [../02_BACK_END/02_SPRING_WEB](../02_BACK_END/02_SPRING_WEB) | Módulo Spring Boot. |
| Java Web | [../02_BACK_END/03_JAVA_WEB](../02_BACK_END/03_JAVA_WEB) | Módulo Java Web con JSP y Servlets. |
