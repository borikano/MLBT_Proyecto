...
| Orden | Código | Carpeta | Propósito |
|---|---|---|---|
...
| 04 | GA8-220501096-AA1-EV01 | [GA8_220501096_AA1_EV01](GA8_220501096_AA1_EV01/README.md) | Integración funcional entre Frontend React, API Node y base de datos. |
| 05 | GA8-220501096-AA1-EV02 | [GA8_220501096_AA1_EV02](GA8_220501096_AA1_EV02/README.md) | Módulos integrados, entradas/salidas, pruebas y URLs públicas de ejecución. |
...
Las evidencias se mantienen separadas por código para evitar mezclar documentos de diferentes actividades. Cada carpeta puede crecer con capturas, resultados, reportes y cierres técnicos sin afectar las demás entregas.
