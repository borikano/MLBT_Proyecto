...
1. `README.md`
2. `03_DOCS/estandares-proyecto-mlbt.md`

Objetivo:

- `README.md`: vision general del sistema, arquitectura, modulos y guia de continuidad.
- `03_DOCS/estandares-proyecto-mlbt.md`: reglas operativas, estandares tecnicos, criterios de UI y decisiones de negocio que deben respetarse.
...
- La documentación técnica debe permanecer en `03_DOCS/`.
